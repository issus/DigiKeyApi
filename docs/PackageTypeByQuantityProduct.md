...
------------ | ------------- | ------------- | -------------
**RecommendedQuantity** | **int?** | The quantity of this package type that is recommended given the provided quantity. | [optional] 
...
**RohsSubs** | [**List&lt;AssociatedProduct&gt;**](AssociatedProduct.md) | Rohs substitutions | [optional] 
**SuggestedSubs** | [**List&lt;AssociatedProduct&gt;**](AssociatedProduct.md) | Suggested substitutions for when the product is obsolete. | [optional] 
