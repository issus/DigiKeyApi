...
namespace DigiKey.Api.Model
{
    ...
    public partial class ProductDetails : IEquatable<ProductDetails>, IValidatableObject
    {
        ...
        /// <param name="rohsSubs">Rohs substitutions  Note: This is now only available in a details call from partsearch..</param>
        /// <param name="suggestedSubs">Suggested substitutions for when the product is obsolete.  Note: Only available in details calls.</param>
        ...
        /// <param name="shippingInfo">Filled with shipping information, restrictions, or empty  REACH is a regulation of the European Union. See documentation from the European Chemicals Agency..</param>
        ...
        /// <summary>
        /// Rohs substitutions  Note: This is now only available in a details call from partsearch.
        /// </summary>
        /// <value>Rohs substitutions  Note: This is now only available in a details call from partsearch.</value>
        [DataMember(Name = "RohsSubs", EmitDefaultValue = false)]
        public List<AssociatedProduct> RohsSubs { get; set; }

        /// <summary>
        /// Suggested substitutions for when the product is obsolete.  Note: Only available in details calls
        /// </summary>
        /// <value>Suggested substitutions for when the product is obsolete.  Note: Only available in details calls</value>
        ...
        /// <summary>
        /// Filled with shipping information, restrictions, or empty  REACH is a regulation of the European Union. See documentation from the European Chemicals Agency.
        /// </summary>
        /// <value>Filled with shipping information, restrictions, or empty  REACH is a regulation of the European Union. See documentation from the European Chemicals Agency.</value>
